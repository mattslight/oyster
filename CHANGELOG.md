...
- **Refreshed share-page chrome.** Public viewer pages drop the top header for a single bottom strip in oyster purple — Oyster brand mark on the left, *Publish AI content with oyster.to* link on the right. Uses Space Grotesk to match the rest of oyster.to.
