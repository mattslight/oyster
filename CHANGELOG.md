...
- **See which folders are attached to a space.** A new *Folders* section shows up at the top of any space view with the linked folders feeding it. If a space has none — easy to miss before, since silent — a red-tinged empty state calls it out and points at `/attach <path>`. ([#266](https://github.com/mattslight/oyster/issues/266))
